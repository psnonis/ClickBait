...
Interaction.allJoinInteract("train", f"normed.masked-${min}%06d.encode.picked-${top}%06d")
Interaction.allJoinInteract("tests", f"normed.masked-${min}%06d.encode.picked-${top}%06d")
Interaction.allJoinInteract("valid", f"normed.masked-${min}%06d.encode.picked-${top}%06d")

Interaction.allPackFeatures("train", f"normed.masked-${min}%06d.encode.picked-${top}%06d.action")
Interaction.allPackFeatures("tests", f"normed.masked-${min}%06d.encode.picked-${top}%06d.action")
Interaction.allPackFeatures("valid", f"normed.masked-${min}%06d.encode.picked-${top}%06d.action")